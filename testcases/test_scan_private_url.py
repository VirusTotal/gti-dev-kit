...
def test_successful_submission(mock_make_api_request):
    ...
    mock_make_api_request.assert_called_once_with(
        "POST", "private/urls", data={"url": "https://example.com"}
    )
...
def test_successful_report(mock_make_api_request):
    ...
    assert result == mock_response
    mock_make_api_request.assert_called_once_with("GET", "private/urls/test_url_id")
...
@patch(
    "examples.file_and_url_scanning.private_scanning.scan_url.scan_private_url_and_get_report"
)
def test_main_successful_scan(mock_scan):
    ...
    from examples.file_and_url_scanning.private_scanning.scan_url import main
...
def test_main_with_print_scan_report_call(mock_scan):
    ...
    with patch(
        "examples.file_and_url_scanning.private_scanning.scan_url.print_scan_report"
...
def test_main_direct_execution_guard():
    ...
    import examples.file_and_url_scanning.private_scanning.scan_url as scan_module
